...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/29825b97ff0f312a433abbe3c8724d38.png)

我们从二元的分类问题开始讨论。

我们将因变量(**dependent variable**)可能属于的两个类分别称为负向类（**negative class**）和正向类（**positive class**），则因变量$y\in { 0,1 \\}$ ，其中 0 表示负向类，1 表示正向类。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/12f14023dfbfce36a3c97658632b5b0a.png)

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/5da75bef000f80abb781625b198a1a58.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/29c12ee079c079c6408ee032870b2683.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/d027a0612664ea460247c8637b25e306.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/e6f8e2a79c70e5ca647a1d2ec65c1018.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/b50a4d539efaa0aafc11dcb71e3f4f06.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/545fcfa517c573cb92f1f955bdadcb0e.png)

并且参数$\theta$ 是向量[-3 1 1]。 则当$-3+{x_1}+{x_2} \geq 0$，即${x_1}+{x_2} \geq 3$时，模型将预测 $y=1$。
我们可以绘制直线${x_1}+{x_2} = 3$，这条线便是我们模型的分界线，将预测为1的区域和预测为 0的区域分隔开。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/e29a3810a136e9f658a522555ea07d0c.jpg)

假使我们的数据呈现这样的分布情况，怎样的模型才能适合呢？

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/197d605aa74bee1556720ea248bab182.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/caef2451f83822e30759cf0ab858c044.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/ebd16ff388f9d7a7f05f101a7a05b9e5.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/54249cb51f0086fa6a805291bf2639f1.png)

${h_\theta}\left( x \right)$与 $Cost\left( {h_\theta}\left( x \right),y \right)$之间的关系如下图所示：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/cf65d78a5859aafa773630d81ec4ec6c.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/42a4d42840a7e9be205c61a1715e90cf.png)
...
![Want ${{\min }_\theta}J(\theta )$：](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/697289f1db9398ca57aea561b8e57093.png)

我们要反复更新每个参数，用这个式子来更新，就是用它自己减去学习率 $\alpha$
乘以后面的微分项。求导后得到：


![Want ：](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/98cef541809f56948bb814b856b9dd2b.png)
...
所以，如果你有 $n$ 个特征，也就是说：![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/06553f8a5b894e5b6fccb5860b8a81ce.png)，参数向量$\theta $包括${\theta_{0}}$ ${\theta_{1}}$ ${\theta_{2}}$ 一直到${\theta_{n}}$，那么你就需要用这个式子：
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/11d48477a40057c5f97e1d4830298588.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/41597ee627007d744ca0f2798a74be8d.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/c760aeebae0a984e7a863bccbde8a20a.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/39746e4da0b0b5ac167479c7a986f3fe.png)

对于一个多类分类问题，我们的数据集或许看起来像这样：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/6e375f9b5f87b7cc0ca8db5c082436a7.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/9b8052afd355ec6268f1547484b47c2f.png)

现在我们有一个训练集，好比上图表示的有3个类别，我们用三角形表示 $y=1$，方框表示$y=2$，叉叉表示 $y=3$。我们下面要做的就是使用一个训练集，将其分成3个二元分类问题。

我们先从用三角形代表的类别1开始，实际上我们可以创建一个，新的"伪"训练集，类型2和类型3定为负类，类型1设定为正类，我们创建一个新的训练集，如下图所示的那样，我们要拟合出一个合适的分类器。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/1265879bba0b33e8eb2ca7e1c4058dae.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/72f84165fbf1753cd516e65d5e91c0d3.jpg)

第一个模型是一个线性模型，欠拟合，不能很好地适应我们的训练集；第三个模型是一个四次方的模型，过于强调拟合原始数据，而丢失了算法的本质：预测新数据。我们可以看出，若给出一个新的值使之预测，它将表现的很差，是过拟合，虽然能非常好地适应我们的训练集但在新输入变量进行预测时可能会效果不好；而中间的模型似乎最合适。

分类问题中也存在这样的问题：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/be39b497588499d671942cc15026e4a2.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/a2f4ec104f2c5677727ddd4614d08630.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/3c4a177cc9dc75a6f6dda8d06ca476f3.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/db7e97f3a4a7b622f2bb431d002256ff.png)
