...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/630c57f24f2019b165e87e02ddb5c50b.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/3ac5e06e852ad3deef4cba782ebe425b.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/ce2093d82fdb0416d3e4f7bd81657a3b.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/2b74c1eeff95db47f5ebd8aef1290f09.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/95c020b2227ca4b9a9bcbd40099d1766.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/697ae58b1370e81749f9feb333bdf842.png)

第三个例子是触觉皮带，如果你把它戴在腰上，蜂鸣器会响，而且总是朝向北时发出嗡嗡声。它可以使人拥有方向感，用类似于鸟类感知方向的方式。

还有一些离奇的例子：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/1ee5c76a62b35384491c603bb54c8c0c.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/3d93e8c1cd681c2b3599f05739e3f3cc.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/d4fcd71de77b1c98616da066a5d54308.png)

神经网络模型建立在很多神经元之上，每一个神经元又是一个个学习模型。这些神经元（也叫激活单元，**activation unit**）采纳一些特征作为输出，并且根据本身的模型提供一个输出。下图是一个以逻辑回归模型作为自身学习模型的神经元示例，在神经网络中，参数又可被成为权重（**weight**）。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/c2233cd74605a9f8fe69fd59547d3853.jpg)

我们设计出了类似于神经元的神经网络，效果如下：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/9abf093f85b78b51bd76ebc9f049c28b.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/8293711e1d23414d0a03f6878f5a2d91.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/74b3775367a186d4447dbcbff169e222.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/a05d7c745971e7b8382863a4c931c4b7.png)

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/2e17f58ce9a79525089a1c2e0b4c0ccc.png)

我们令 ${{z}^{\left( 2 \right)}}={{\theta }^{\left( 1 \right)}}x$，则 ${{a}^{\left( 2 \right)}}=g({{z}^{\left( 2 \right)}})$ ，计算后添加 $a_{0}^{\left( 2 \right)}=1$。 计算输出的值为：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/43f1cb8a2a7e9a18f928720adc1fac22.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/8054ee25585965c4ff60deea1e8d7b7d.png)

右半部分其实就是以$a_0, a_1, a_2, a_3$, 按照**Logistic Regression**的方式输出$h_\theta(x)$：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/0441013766cb2e68016f5ed4e8b76b73.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/ce3d1a1c7aff8101a4e0c8d02bbe6110.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/bcbcdcbcb455a71928c8b90fc386a8e1.png)



![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/e820efb6966c374745efc0683f3a58f0.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/9a6c038e6a85e7154f77d2ec9ad58f83.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/acb31d5e0186d45f697041120b8278a4.png)

下图的神经元（三个权重分别为-10，20，20）可以被视为作用等同于逻辑或（**OR**）：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/e4a61683d95db8916b8ee8d332b85263.png)

下图的神经元（两个权重分别为 10，-20）可以被视为作用等同于逻辑非（**NOT**）：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/269e6ae821bd2fd3fc1366e091187b94.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/318525b49ac885501f2662969882be63.png)

然后将表示 **AND** 的神经元和表示$\left( \text{NOT}\, \text{x}_1 \right) \text{AND} \left( \text{NOT}\, \text{x}_2 \right)$的神经元以及表示 OR 的神经元进行组合：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/3e1f858ba64ba4a2a894b8b472a1ed27.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/5c4d171701bdae5e2673b23969a8b45f.jpg)

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/685180bf1774f7edd2b0856a8aae3498.png)

神经网络算法的输出结果为四种可能情形之一：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/5e1a39d165f272b7f145c68ef78a3e13.png)
