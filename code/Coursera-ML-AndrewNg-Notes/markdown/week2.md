...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/591785837c95bca369021efa14a8bb1c.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/41797ceb7293b838a3125ba945624cf6.png)

即：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/6bdaff07783e37fcbb1f8765ca06b01b.png)

求导数后得到：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/dd33179ceccbd8b0b59a5ae698847049.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/f4990470cacff936fce9bd4b435174ea.jpg)

解决的方法是尝试将所有特征的尺度都尽量缩放到-1到1之间。如图：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/97c5e67685e77eb3bfab5d14903a8b81.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/cd4e3df45c34f6a8e2bb7cd3a2849e6c.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/2ff71a2fee3d0d0f9137fa4268507467.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/3a47e15258012b06b34d4e05fb3af2cf.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/347b54c80e8974b3ea0ea3aa05ebd91b.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/5b67264df48a6ca4808ea4e48b026325.png)

即：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/c8eedc42ed9feb21fac64e4de8d39a06.png)

运用正规方程方法求解参数：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/b62d24a1f709496a6d7c65f87464e911.jpg)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/e549c9e2a4c3b994f5cbd709e1fec4c9.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/dca7e776402ebbad2d53c442a11117d3.png)

这些都是基本的数学运算。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/f8507899953ed2de68e6b2b83554f9ea.png)

你也可以做逻辑运算，例如 1==2，计算结果为 **false** (**假**)，这里的百分号命令表示注释，1==2 计算结果为假，这里用0表示。

请注意，不等于符号的写法是这个波浪线加上等于符号 ( \~= )，而不是等于感叹号加等号( != )，这是和其他一些编程语言中不太一样的地方。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/126b2a5c4b5bfb24e5c21cd080159530.png)

让我们看看逻辑运算 1 && 0，使用双&符号表示逻辑与，1 && 0判断为假，1和0的或运算 1 \|\| 0，其计算结果为真。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/fec0936e2a78c0fe8c9e3ed107614a31.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/8d63fe546c12a7e9eb658118d76288f7.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/a537df35ccc9ff83a3c7518362e2f729.png)

如果你想分配一个变量，但不希望在屏幕上显示结果，你可以在命令后加一个分号，可以抑制打印输出，敲入回车后，不打印任何东西。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/c11786828c587189891a9ef02f041ab7.png)

其中这句命令不打印任何东西。

现在举一个字符串的例子：变量$b$等于"**hi**"。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/4b67374499c0d38ed8670ba74ff892d0.png)

$c$等于3大于等于1，所以，现在$c$变量的值是真。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/acedf91b6b39d551e62a89f2e0955628.png)

如果你想打印出变量，或显示一个变量，你可以像下面这么做：

设置$a$等于圆周率$π$，如果我要打印该值，那么只需键入`a`像这样 就打印出来了。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/2cdc09b8bf67e546df7284ba74601c66.png)

对于更复杂的屏幕输出，也可以用**DISP**命令显示：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/bcd1f570fbf265786f9e5cde3450d9cb.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/ba8f0c3d2d8f017e0f7a611aa5be75d6.png)

下面，让我们来看看向量和矩阵：

比方说 建立一个矩阵$A$：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/c318123745ed492ee175d68e0992bc52.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/1cdbd87db83a4184098cd6d5ee3c6a87.png)

这里还有一些其他的方法来生成矩阵

例如“`ones(2, 3)`”，也可以用来生成矩阵：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/5d2b25d4078a276091b9c00812674fa9.png)

元素都为2，两行三列的矩阵，就可以使用这个命令：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/21985f8690965598d4a17e3a6e7fee94.png)

你可以把这个方法当成一个生成矩阵的快速方法。

$w$为一个一行三列的零矩阵，一行三列的$A$矩阵里的元素全部是零：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/846b48ec79c9fcee05b20767dcc89558.png)

还有很多的方式来生成矩阵。

如果我对$W$进行赋值，用**Rand**命令建立一个一行三列的矩阵，因为使用了**Rand**命令，则其一行三列的元素均为随机值，如“`rand(3,3)`”命令，这就生成了一个3×3的矩阵，并且其所有元素均为随机。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/0de6e7054e869a82060cefa9968cd56b.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/048f3cac1c32e3dc56160849c4dd60b0.png)

还可以设置地更复杂：

并用**hist**命令绘制直方图。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/10c06cc39058da2c5eef696d75e65a2c.png)

绘制单位矩阵：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/64237eb36fbe7163e170901e17a9b792.png)

如果对命令不清楚，建议用**help**命令：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/79b55d71cf434126f3d8457a3a615d18.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/4bfdf675e51ee02bf36eeafdf352c5eb.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/c7fe19ff21cfaad6221596fd6122439f.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/e4080d69119a0e408581c81a66e133c8.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/8c47f1fac72ff5f60d87eb45f323d07b.png)

所以我可以键入`featuresX` 回车，来显示 **featuresX**

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/5aece7a957deabc1a8af2ba27c10dbfd.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/4a2f4421b79d856770768a1cc5595a5d.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/a8c3b363f13820b4fc6463c7520ab58c.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/b39bf4e9212442464fe2f568dbe4fa0c.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/d1d551d0c540449d457e312a34434355.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/f47bda45fd9beef6c600ebd48d163617.png)

接下来一个操作，让我们把 $A $设为`A = [A, [100, 101,102]]`，这样做的结果是在原矩阵的右边附加了一个新的列矩阵，就是把 $A$矩阵设置为原来的 $A$ 矩阵再在右边附上一个新添加的列矩阵。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/84640261790c88aa051b3f0759ed4c3f.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/e07db429512d4b3b5d641c52e606159d.png)

我还可以设`C = [A; B]`，这里的分号表示把分号后面的东西放到下面。所以，`[A;B]`的作用依然还是把两个矩阵放在一起，只不过现在是上下排列，所以现在 $A$ 在上面 $B$在下面，$C$ 就是一个 6×2 矩阵。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/7f11aa788b1b75c5a534d030b3ebc624.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/df506aeafd3e3c1d9922c2a21663d890.png)

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/79b5017c35f51acd576f45712f03bf2e.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/694f6cff7cecc2f5072ec5ff4dfcb2bc.png)

这里是一个矩阵$A$，这里我输入`A.^2`，这将对矩阵$A$中每一个元素平方。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/fb123db7188ceb848af686eea6d223c8.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/0c7c1d7726c09ffb45152cf153614003.png)

还有自然数$e$的幂次运算，就是以$e$为底，以这些元素为幂的运算。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/a36506049248948c82e598c8c254dc31.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/ca7e937622f77821b7afad6b2a060dd5.png)

另一种更简单的方法是直接用 `v+1`，`v + 1` 也就等于把 $v$ 中的每一个元素都加上1。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/e02eec3ca4688ff1cb9126c8eb13bfed.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/fc04d42876c9d7d7bed51bade2077649.png)

因此，返回[1 1 0 1]。也就是说，对$a$矩阵的每一个元素与3进行比较，然后根据每一个元素与3的大小关系，返回1和0表示真与假。

如果我写 `find(a<3)`，这将告诉我$a$ 中的哪些元素是小于3的。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/ac9ad10f115d2d1cd15a0514c8ceeafa.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/f8c7f4f36183ef4b36bce427be2fce6f.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/99082a148065a5027882b232b15945f6.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/508d0aacaa26e7f8f442163491cb1e26.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/5cb00d6cea503086a50676f152fd4358.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/3156591fe619a18a59e032abf8d940bb.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/4514b422525aaac1e99add67e44882ee.png)

如果我想绘制正弦函数，这是很容易的，我只需要输入`plot(t,y1)`，并回车，就出现了这个图：

![C:\\Users\\风度78\\AppData\\Roaming\\Tencent\\Users\\10822884\\QQ\\WinTemp\\RichOle\\8\~NJ7J5F0JE7}UOS%)(JN_G.png](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/ff08dcc5b9718aa9c744e13fcc4fd607.png)

横轴是$t$变量，纵轴是$y1$，也就是我们刚刚所输出的正弦函数。

让我们设置$y2$

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/2d32a23ab895a8e765caf90a7679817e.png)

**Octave**将会消除之前的正弦图，并且用这个余弦图来代替它，这里纵轴$cos(x)$从1开始，

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/38969cc85853190ff3eac4f06398bc1b.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/9eb4e496f34a801fd7ba5e85c4eec66b.png)

同时我也可以来标记我的两条函数曲线，用这个命令 `legend('sin','cos')`将这个图例放在右上方，表示这两条曲线表示的内容。最后输入`title('myplot')`，在图像的顶部显示这幅图的标题。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/23594175efe66d5b9b1e687375a2dbda.png)

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/c765aeee9c53e0e77d01d1e73cabd9b4.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/a4cb19b18a576af50270c6af36a76958.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/f9a0f49ecab994e426ea108c8536e03c.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/82a990a5832ae2618d768551b90470dc.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/ede9c504c168dfa741ec3eb4f16b3ff0.png)

你可以看到在不同的方格，它对应于一个不同的灰度。

输入`imagesc(magic(15))，colorbar，colormap gray`

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/22a9a9536d4db17b6d64603fb54dce9e.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/875ce0bfe9ef97eb5e0fe9c975e398c2.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/26a912d550af9fd43a7ae62e3b610e97.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/890f6ea8f857f22002f98c20d52b3bb8.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/0e23f22e3ee80221b12ae369b28d586a.png)

如果你对 “**break**” 和 “**continue**” 语句比较熟悉，**Octave**里也有 “**break**” 和 “**continue**”语句，你也可以在 **Octave**环境里使用那些循环语句。

但是首先让我告诉你一个 **while** 循环是如何工作的：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/1b37f81896a59145576ae996c9dd4d16.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/279cfbda6b4d9a2ced1332f086db4d9e.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/507b8c952d661a97bb713f7cc80bf58a.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/247f96f4e7ab7a259ac9ef1eebe0b503.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/6c912532ce2bd2e6c910a3a9fab1505d.png)

请仔细看一下这个函数的定义，确保你明白了定义中的每一步。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/93ba97062751db1268be6b6668ba89ac.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/e631b75be1cd5c7a1a881a7f4b0f7d11.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/f6bb36ade318b22544289c069a937443.png)

比如说，这是未向量化的代码实现方式：

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/806e6477193e7624f5cd83be4df9c3a2.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/e6582448a371ca3d3e2080ed0ff566d4.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/19d6530a6d6898dfc259db8fa0cdd0fa.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/6ad266a30f955db5b905905670aabfc5.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/d5d6805aa30b112be2d157a1be553442.png)

让我解释一下是怎么回事：我要把$\theta$看作一个向量，有一个 $n+1$ 维向量，$\alpha$ 是一个实数，$\delta$在这里是一个向量。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/41898e8bdfb232f972dca6a85e5708e1.png)

所以这个减法运算是一个向量减法，因为 $\alpha$ 乘以 δ是一个向量，所以$\theta$就是$\theta$ - $\alpha \delta$得到的向量。

那么什么是向量 $\delta$ 呢 ?

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/98e00b7bc21b4b358cab4de8994a20dd.png)

$X^{(i)}$是一个向量

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/0a03d239f2f1d1af057d492bcce276f4.png)

你就会得到这些不同的式子，然后作加和。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/fa6240891c1d6254f68b07cf298e3b9f.png)

实际上，在以前的一个小测验，如果你要解这个方程，我们说过为了向量化这段代码，我们会令`u = 2v +5w`因此，我们说向量$u$等于2乘以向量$v$加上5乘以向量$w$。用这个例子说明，如何对不同的向量进行相加，这里的求和是同样的道理。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/a532468f78835c53b90365b91ef59d9e.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/c2ff76917dac29f8e20d0a3eb4a2e6a8.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/40bbad74a33b5909dddf9d07f221bebd.png)
...
![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/924ebb4a319cc516b27fd786e4e41487.png)

我现在可以按如下步骤提交代码，我要在这里目录下键入`submit()`。我要提交第一部分 所以我选择输入'`1`'。这时它问我的电子邮件地址，我们打开课程网站，输入用户名密码。

![](http://yuquemd.s3-us-east-1.ossfiles.com/2023/04/0899fd8380b934f1c1b71ffd49e048cf.png)
